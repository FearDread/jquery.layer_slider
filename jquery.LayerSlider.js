...
(function($) {
    ...
    $.layerSlider = function($el, opts) {
        ...
        this.methods = {
            ...
            slide_prev: function() {
                ...
                switch (slider.opts.style) {
                    case 'random':
                        ...
                        this.animate(prev, slider.animations.fade[rand]);
                        break;
            ...
            cycle: function() {
                var _this = this, item, lenth;

                lenth = slider.data.length;
            ...
            init: function() {
                console.log('INFO :: Layers Slider :: ', slider.opts);
                // Markup //
                this.setup();
